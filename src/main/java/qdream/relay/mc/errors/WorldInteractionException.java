...
public class WorldInteractionException extends ExecutionException {
    public WorldInteractionException(StateMachine executor, String message) {
        super(executor, message);
    }

    public WorldInteractionException(StateMachine executor, String message, Throwable cause) {
