...
public class RelayItems {
    ...
    public static final Item SPELL_DISK = register("spell_disk", Item::new, new Item.Properties());
    ...
    public static void register() {
        ...
        CreativeModeTabEvents.modifyOutputEvent(CreativeModeTabs.INGREDIENTS)
                .register((creativeTab) -> creativeTab.accept(RelayItems.COMPUTING_CORE));
        CreativeModeTabEvents.modifyOutputEvent(CreativeModeTabs.INGREDIENTS)
                .register((creativeTab) -> creativeTab.accept(RelayItems.SPELL_DISK));
        CreativeModeTabEvents.modifyOutputEvent(CreativeModeTabs.INGREDIENTS)
                .register((creativeTab) -> creativeTab.accept(RelayItems.ENERGY_MODULE));
        // Register the group.
